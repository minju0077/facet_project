  ...
  <div class="border-b border-gray-100 bg-white/95 backdrop-blur-sm sticky top-0 z-50">
    <div class="max-w-[1440px] mx-auto px-4 md:px-10 h-20 flex justify-between items-center">
      <div class="flex items-center space-x-12">
        <a href="/auction/main_auction.html" class="flex items-center">
          <div
        ...
        <nav class="hidden lg:flex items-center space-x-8 text-[14px] font-medium text-gray-500">
          <a href="/auction/main_auction.html" class="text-black border-b-2 border-black py-1"
            >경매</a
          >
          <a href="/funding/main_funding.html" class="hover:text-black transition-colors py-1"
            >펀딩</a
          >
        </nav>
      </div>
      ...
      <div class="flex items-center">
        <a href="./mypage.html" class="icon-btn" aria-label="My Page">
